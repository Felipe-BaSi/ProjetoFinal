  ...
  else
  {
    ...
    switch (c)
    {
      case '!':
        ...
        index = (37 + 26) * 8; // Índice do caractere '!'
        break;

      case '"':

        index = (37 + 26 + 1) * 8; // Índice do caractere '"'
        break;

      case '#':

        index = (37 + 26 + 2) * 8; // Índice do caractere '#'
        break;

        case ':':

        index = (37 + 26 + 3) * 8; // Índice do caractere ':'
        break;

        case '%':

        index = (37 + 26 + 4) * 8; // Índice do caractere '%'
        break;
